...
const Teaser2ColumnsGreyFeatured = (props) => {
  const {
    data,
    isEditMode,
    id,
    ...
    <>
      ...
      {href && (
        <div className="home-teaser-item featured">
          <Grid
            className="home-teaser-item-content bg-grey"
            columns={2}
            stackable
          >
...
Teaser2ColumnsGreyFeatured.propTypes = {
  data: PropTypes.objectOf(PropTypes.any).isRequired,
  isEditMode: PropTypes.bool,
};

export default Teaser2ColumnsGreyFeatured;
